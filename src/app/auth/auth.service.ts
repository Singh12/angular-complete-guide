...
import { AuthenticateFail } from './store/auth.action';
...
export class AuthService {
    ...
    //     this.store.dispatch(new AuthActions.AuthenticateSuccess({email, userId: localId, token: idToken, expirationDate}));
    //     // this.user.next(user);
